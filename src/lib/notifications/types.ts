...
// notifications-notes.sql, qui a le détail le plus récent) et avec
// CATEGORIES_VALIDES dans supabase/functions/send-push/index.ts.
...
export const CATEGORIES_NOTIFICATION: {
  ...
  },
  {
    value: 'notes',
    label: 'Notes',
    description: 'Nouvelle note ajoutée par un collègue.',
  },
]
