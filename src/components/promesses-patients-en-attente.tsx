...
import {
  FormulairePromesse,
  formDataPromesse,
  type ChampsNouvellePromesse,
} from '@/components/promesses-patients-formulaire'
...
export function PromessesPatientsEnAttente({ promesses }: { promesses: PromessePatient[] }) {
  ...
  async function enregistrer(champs: ChampsNouvellePromesse): Promise<boolean> {
    const formData = formDataPromesse(champs)
