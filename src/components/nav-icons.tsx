...
export function IconAccueil({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconLiaison({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconCarnet({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M15 8h4M15 12h4M6 16h12" />
    </svg>
  )
}
